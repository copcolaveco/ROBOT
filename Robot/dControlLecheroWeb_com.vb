Public Class dControlLecheroWeb_com
#Region "Atributos"
    ...
    Private m_path_rodeo As String
...
#Region "Getters y Setters"
    ...
    Public Property PATH_CSV() As String
        ...
        End Set
    End Property
    Public Property PATH_RODEO() As String
        Get
            Return m_path_rodeo
        End Get
        Set(ByVal value As String)
...
#Region "Constructores"
    ...
    Public Sub New(ByVal id As Long, ByVal id_usuario As Long, ByVal comentario As String, ByVal abonado As Integer, _
                   ...
                   ByVal path_pdf As String, ByVal path_csv As String, ByVal path_rodeo As String, ByVal ficha As String, _
...
#Region "Métodos ABM"
    Public Function guardar() As Boolean
        Dim c As New pControlLecheroWeb_com
        Return c.guardar(Me)
    End Function
    ...
    End Function
    Public Function buscar() As dControlLecheroWeb_com
        Dim c As New pControlLecheroWeb_com
        Return c.buscar(Me)
    End Function

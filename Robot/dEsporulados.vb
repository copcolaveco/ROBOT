...
#Region "Constructores"
    Public Sub New()
        ...
        m_resultado = ""
    End Sub
    Public Sub New(ByVal id As Long, ByVal fecha As String, ByVal ficha As Long, ByVal muestra As String, ByVal valor1 As String, ByVal valor2 As String, ByVal valor3 As String, ByVal resultado As String)
        m_id = id
        m_fecha = fecha
        m_ficha = ficha
        m_muestra = muestra
...
#Region "Métodos ABM"
    ...
    End Function
    Public Function buscar() As dEsporulados
        Dim r As New pEsporulados
        Return r.buscar(Me)
    End Function
    Public Function buscarxfichaxmuestra() As dEsporulados
        Dim r As New pEsporulados

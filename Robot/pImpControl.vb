Public Class pImpControl
    Inherits Conectoras.ConexionMySQL
    Public Function guardar(ByVal o As Object) As Boolean
        Dim obj As dImpControl = CType(o, dImpControl)
    ...
    Public Function eliminar(ByVal o As Object) As Boolean
        Dim obj As dImpControl = CType(o, dImpControl)
        Dim sql As String = "DELETE FROM control WHERE ID = " & obj.ID
        ...
        Return EjecutarTransaccion(lista)
    End Function
    Public Function buscar(ByVal o As Object) As dImpControl
        Dim obj As dImpControl = CType(o, dImpControl)
    ...
    Public Function listarporid(ByVal texto As Long) As ArrayList
        Dim sql As String = ("SELECT id, ficha, fecha, equipo, producto, muestra, rc, grasa, proteina, lactosa, st, crioscopia, urea, proteinav, caseina, densidad, ph, bhb FROM control where ficha = " & texto)
        Try
            Dim Lista As New ArrayList
            Dim Ds As New DataSet
            Ds = Me.EjecutarSQL(sql)

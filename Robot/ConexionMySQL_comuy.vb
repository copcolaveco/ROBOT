...
Namespace Conectoras
    Public Class ConexionMySQL_comuy
        ...
        Private Shared mCadenaConexion As String = "Server=colaveco.com.uy;Port=3306;DataBase=colaveco_sitio;Uid=colaveco;Pwd=NUEVA**!!COL22$%;Convert Zero DateTime=true;"

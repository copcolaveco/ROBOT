...
#Region "Métodos ABM"
    ...
    End Function
    Public Function buscar() As dInhibidores
        Dim c As New pInhibidores
        Return c.buscar(Me)
    End Function
    Public Function buscarxfichaxmuestra() As dInhibidores
        Dim c As New pInhibidores
...
#End Region
    ...
    Public Function listarporidgrupal(ByVal texto As Long) As ArrayList
        Dim c As New pInhibidores
        Return c.listarporidgrupal(texto)
    End Function

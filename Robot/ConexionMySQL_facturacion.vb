...
Namespace Conectoras
    Public Class ConexionMySQL_facturacion
        ...
        Private Shared mCadenaConexion As String = "Server=192.168.1.20;Database=bd_sistemas;Uid=root;Pwd=root;Convert Zero Datetime=True"

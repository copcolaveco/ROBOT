...
#Region "Métodos ABM"
    ...
    End Function
    Public Function buscar() As dCalidad
        Dim c As New pCalidad
        Return c.buscar(Me)
    End Function
    Public Function buscarxfichaxmuestra() As dCalidad
        Dim c As New pCalidad
        Return c.buscarxfichaxmuestra(Me)
    End Function

    Public Function guardaraux() As Boolean
        Dim c As New pCalidad
        Return c.guardaraux(Me)
    End Function
    Public Function guardaraux2() As Boolean
        Dim c As New pCalidad
        Return c.guardaraux2(Me)
    End Function
    Public Function buscaraux(ByVal ficha As String, ByVal muestra As String) As dCalidad
        Dim c As New pCalidad
        Return c.buscaraux(ficha, muestra)
    End Function

...
Namespace Conectoras
    Public Class ConexionMySQL_Florida
        ...
        Private Shared mCadenaConexion As String = "Server=colaveco.com.uy;Port=3306;DataBase=colaveco_clv_florida;Uid=colaveco;Pwd=NUEVA**!!COL22;Convert Zero DateTime=true;"
